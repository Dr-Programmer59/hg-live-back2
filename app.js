...
// 	const addProducer = (producer, roomName,admin) => {
// 	  producers = [
// 		...producers,
// 		{ socketId: socket.id, producer, roomName,admin }
// 	  ]
...
// 	  console.log("this is new producer having deatils ",producers)
// 	  peers[socket.id] = {
// 		...peers[socket.id],
// 		producers: [
...
// 	  socket.to(roomName).emit("recive-message",{message})
// 	})
...
// 		}
// 	  })
// 	  console.log("this is producer list ",producerList)
...
// 	  producers.forEach(producerData => {
// 		if (producerData.socketId !== socketId && producerData.roomName === roomName && producerData.admin) {
// 		  const producerSocket = peers[producerData.socketId].socket
// 		  // use socket to send producer id to producer
// 		  console.log("new person came")
...
// 	  console.log("got all producers of room   ",roomName)
// 	  console.log(waitingHosts)
// 	  let hostData={}
...
// 	  console.log("this is waiting host",waitingHosts)
// 	  let hostData=[]
// 	  producers.forEach(producerData => {
// 		if ( ! waitingHostSocket.includes(producerData.socketId) && producerData.roomName === roomName && !producerData.admin) {
...
// 	socket.on('transport-produce', async ({ kind, rtpParameters, appData ,admin}, callback) => {
...
// 	  addProducer(producer, roomName,admin)
